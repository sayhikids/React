...
public class TodoService {
  ...
  @Autowired
  private TodoRepository repository; //DB에 CRUD 하는 역할을 하는 애..

  public String testService() {
    // TodoEntity 생성(Entity IS TABLE)
    TodoEntity entity = TodoEntity.builder().title("My first todo item").build();
    // TodoEntity 저장
    repository.save(entity); //Insert 처리, save() 만약 기존 Entity 가 올라와 있으면, 바뀐 내용만 조회 후 update 처리함.
    // TodoEntity 검색
